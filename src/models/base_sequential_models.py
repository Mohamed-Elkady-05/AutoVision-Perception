...
class RNN_Model(BaseSequentialModel):
    """
...
class GRU_Model(BaseSequentialModel):
    """
...
if __name__ == "__main__":
    ...
    # Test RNN
    rnn_model = RNN_Model(input_size=input_size, hidden_size=256, num_layers=2, output_size=43, device=device)
    ...
    # Test GRU
    gru_model = GRU_Model(input_size=input_size, hidden_size=256, num_layers=2, output_size=43, device=device)
